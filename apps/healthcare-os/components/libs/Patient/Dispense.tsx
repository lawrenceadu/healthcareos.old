                  ...
                  >
                    ...
                    >
                      ...
                      <Select
                        ...
                        onSelect={(value) => setFieldValue('dose_unit', value)}
                      />
                    </Field.Group>
                    ...
                    <div>
                      {key === 0 && (
                        <Dropdown>
                          <Dropdown.Toggle type="button" className="mt-6 px-3">
                            <NotesIcon />
                          </Dropdown.Toggle>
                          <Dropdown.Menu className="max-w-[300px] p-4">
                            <div>
                              Lorem ipsum dolor sit amet consectetur adipisicing
                              elit. Placeat nesciunt necessitatibus rem, at,
                              fuga consequuntur doloribus veritatis aliquid
                              recusandae velit id, quam expedita. Atque magnam,
                              autem tempora in harum quaerat?
                            </div>
                          </Dropdown.Menu>
                        </Dropdown>
                      )}
